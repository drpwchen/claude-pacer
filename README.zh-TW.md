...
撞牆後自動按 continue 的工具不少；這套的重點是撞牆「前」行為就改變：
85% 起 Claude 不再開新的大工程，93% 把手上的步驟收乾淨，然後自己排程
額度重置後從同一個對話接續。不會留下寫到一半的檔案或卡在中間的操作。
...
整行是**自適應**的：先畫完整版，放不下就逐步降級——先試完整版＋
縮短主題，再降緊湊版（4 格長條配**剩餘時間**，因為長條本身已表達
用量），最後只剩百分比。終端寬度
